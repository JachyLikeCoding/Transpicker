...
CUDA_VISIBLE_DEVICES=1 python ../src/main.py --coco_path /home/zhangchi/transpicker/Transpicker/data/empiar10028 --dataset_file cococryo_percent --image_percent 100 --output_dir ../outputs/empiar10028_outputs_100 > log_data_percent100.txt